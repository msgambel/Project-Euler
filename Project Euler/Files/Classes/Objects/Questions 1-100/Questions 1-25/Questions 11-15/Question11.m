...
- (MovingProduct4)array:(NSArray *)aArray startIndex:(int)aStartIndex endIndex:(int)aEndIndex incrementAmount:(int)aIncrementAmount;
...
- (void)initialize; {
  ...
  self.estimatedComputationTime = @"4.55e-04";
  self.estimatedBruteForceComputationTime = @"4.55e-04";
}
...
- (MovingProduct4)array:(NSArray *)aArray startIndex:(int)aStartIndex endIndex:(int)aEndIndex incrementAmount:(int)aIncrementAmount; {
  ...
  if(aIncrementAmount != 0){
    BOOL shouldContinue = (aEndIndex > (aStartIndex + (4 * aIncrementAmount)));
    
    if(aIncrementAmount < 0){
      shouldContinue = (aEndIndex < (aStartIndex + (4 * aIncrementAmount)));
    }
    ...
    if(shouldContinue){
      ...
      for(int i = 0; i < 4; i++){
        ...
        digitValue = [[aArray objectAtIndex:index] intValue];
