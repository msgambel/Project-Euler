...
- (void)initialize; {
  ...
  self.hint = @"Triangle numbers really only have 2 factors: n and (n+1). Those numbers are much easier to divide than the triangle number itself.";
  ...
  self.number = @"12";
  self.rating = @"4";
  self.summary = @"As a child, Gauss could have done this with ease. Now, with modern computers, you can too!";
