...
- (void)initialize; {
  ...
  self.answer = @"9183";
  self.number = @"29";
  self.keywords = @"base,power,unique,integer,combinations,numerical,order,distinct,sequence,repeats,removed";
...
- (void)computeAnswer; {
  ...
  // reduce them to lowest base/pair form, check them against all the numbers
