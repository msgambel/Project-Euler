...
- (void)initialize; {
  ...
  self.hint = @"Instead of checking if a base 10 number is a palindrome, write a function that generates all base 10 palindromes less that 1,000,000, and check if those palindromes are also base 2 palindromes.";
  self.link = @"https://en.wikipedia.org/wiki/Palindrome";
