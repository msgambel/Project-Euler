...
- (void)initialize; {
  ...
  self.hint = @"Make a helper method that reduces a Roman numeral to its minimal form.";
  self.link = @"https://en.wikipedia.org/wiki/Roman_numerals";
