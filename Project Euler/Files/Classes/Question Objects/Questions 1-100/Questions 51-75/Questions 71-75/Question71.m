...
- (void)initialize; {
  ...
  self.hint = @"Some algebra and modular arithmetic will do you good!";
  self.link = @"https://en.wikipedia.org/wiki/Fraction_(mathematics)#Proper_and_improper_fractions";
