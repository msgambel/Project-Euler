...
- (void)initialize; {
  ...
  self.answer = @"121313";
  self.number = @"51";
  self.keywords = @"prime,value,family,digit,replacements,number,eight,8,*";
...
- (void)computeAnswer; {
  ...
  // belong to an 8 prime family with repeating digits. We know that it must
  // be a 6 digit prime because of the following:
  //
