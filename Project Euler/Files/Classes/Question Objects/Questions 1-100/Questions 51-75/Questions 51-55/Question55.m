...
- (void)initialize; {
  ...
  self.answer = @"249";
  self.number = @"55";
  self.keywords = @"lychrel,numbers,palindrome,sum,add,reverse,iterations,10000,ten,thousand,50,fifty,palindromic";
...
- (void)computeAnswer; {
  ...
  // numbers from 1 up to 10,000 are Lychrel. If thre number is NOT a Lychrel
